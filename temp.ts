...
// Project: Community Maintained League of Legends type
//          definitions as defined by https://developer.riotgames.com/api-methods/
...
export interface RealmDto {
    ...
    profileiconmax: number; /* Special behavior number identifying the largest
                            profile icon ID that can be used under 500.
